...
export const tokensConfig = {
  ...
  tailwindBridge: {
    ...
    "color-surface-tint-danger-foreground": "color-surface-tint-danger-foreground",
    "color-surface-tint-success-foreground": "color-surface-tint-success-foreground",
    "color-surface-tint-info-foreground": "color-surface-tint-info-foreground",
    "color-surface-tint-warning-foreground": "color-surface-tint-warning-foreground",
    "color-surface-tint-primary-foreground": "color-surface-tint-primary-foreground",
