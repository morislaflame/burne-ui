...
export const designTokenNames = [
  ...
  "--selection-indicator-radius-xsmall",
  "--selection-indicator-radius-small",
  "--selection-indicator-radius-base",
  "--selection-indicator-radius-mid",
  "--selection-indicator-radius-large",
  "--radius",
  "--radius-xsmall",
  "--radius-small",
  "--radius-base",
