...
export const CHECKBOX_SIZE_LAYOUT: Record<
  CheckboxSize,
  {
    title: TextVariant;
    desc: TextVariant;
...
export const CHECKBOX_LABEL_CLASS = "inline-flex flex-wrap items-center gap-x-xsmall gap-y-0";
...
export const CHECKBOX_SIMPLE_LABEL_TEXT_CLASS = "min-w-0";
