...
export function App() {
  return (
    <div className="relative min-h-[100dvh] bg-background text-foreground">
      <div className="pointer-events-none absolute left-4 top-4 z-10 max-w-[min(90vw,28rem)] rounded-small border border-base/60 bg-surface/85 py-plus px-mid text-sm shadow-lg backdrop-blur-md">
