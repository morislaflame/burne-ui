import { activateThemeModePalette, createDefaultEditorState, ensureModePalettes, type ThemeColors, type ThemeEditorState, type ThemeMode } from "./themeDefaults";

import { AMBER_DARK_COLORS, AMBER_LIGHT_COLORS, AUTUMN_DARK_COLORS, AUTUMN_LIGHT_COLORS, BERRY_DARK_COLORS, BERRY_LIGHT_COLORS, BOLD_DARK_COLORS, BOLD_LIGHT_COLORS, CHERRY_DARK_COLORS, CHERRY_LIGHT_COLORS, CONTRAST_DARK_COLORS, CONTRAST_LIGHT_COLORS, DARK_COLORS, DREAMLAND_DARK_COLORS, DREAMLAND_LIGHT_COLORS, EARTHY_DARK_COLORS, EARTHY_LIGHT_COLORS, EMERALD_DARK_COLORS, EMERALD_LIGHT_COLORS, HARVEST_DARK_COLORS, HARVEST_LIGHT_COLORS, LAVENDER_DARK_COLORS, LAVENDER_LIGHT_COLORS, LIGHT_COLORS, MYSTIC_DARK_COLORS, MYSTIC_LIGHT_COLORS, OCEAN_DARK_COLORS, OCEAN_LIGHT_COLORS, PAPRIKA_DARK_COLORS, PAPRIKA_LIGHT_COLORS, PEACH_DARK_COLORS, PEACH_LIGHT_COLORS, ROSE_DARK_COLORS, ROSE_LIGHT_COLORS, RUSTIC_DARK_COLORS, RUSTIC_LIGHT_COLORS, SAND_DARK_COLORS, SAND_LIGHT_COLORS, SLATE_DARK_COLORS, SLATE_LIGHT_COLORS, TOFFEE_DARK_COLORS, TOFFEE_LIGHT_COLORS, VIOLET_DARK_COLORS, VIOLET_LIGHT_COLORS } from "./themePalettes";
